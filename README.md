...
# About the Project
## Inspiration
When someone gets sick or injured, they’re often overwhelmed — especially students, low-income families, and people unfamiliar with the healthcare system. They’re forced to answer multiple stressful questions at once:
...
We built Care Compass to eliminate this confusion — to become a trusted, AI-powered guide that helps anyone, regardless of background or income, navigate healthcare with confidence and clarity.

## What it does?
Care Compass takes user input — including symptoms, medical history, location, and insurance plan — and intelligently matches them to the best available, in-network healthcare options.
It provides:
...
UI Design: Focused on accessibility, empathy, and simplicity, ensuring users can make confident care decisions quickly — even in stressful situations.
...
Developed a solution that truly serves vulnerable users — especially students and lower-income groups who often struggle most with healthcare navigation.
